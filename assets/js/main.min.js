...
function () {
  ...
  */
  function IroColor(value, onChange) {
    ...
    this.initialValue = _extends$1({}, this.$); // copy initial value
  }
  /**
  ...
  */
  ...
  _proto.setChannel = function setChannel(format, channel, value) {
    ...
    this[format] = _extends$1({}, this[format], (_extends2 = {}, _extends2[channel] = value, _extends2));
  }
  /**
  ...
  */
  ...
  _createClass(IroColor, [{
    ...
    set: function set(newValue) {
      var oldValue = this.$;
      newValue = _extends$1({}, oldValue, newValue); // If this Color is being watched for changes we need to compare the new and old values to check the difference
    ...
    set: function set(value) {
      this.hsv = _extends$1({}, IroColor.rgbToHsv(value), {
    ...
    set: function set(value) {
      this.hsv = _extends$1({}, IroColor.hslToHsv(value), {
        a: value.a === undefined ? 1 : value.a
      });
    }
  }, {
...
*/
var colorPicker = new iro$1.ColorPicker("#color-picker", {
